...
char		window_title[] = "Csintalan Mate Adam 2. bedando";
...
glm::vec3 controlPointsColor = glm::vec3(0.3f, 1.0f, 0.0f);
glm::vec3 controlPoligonColor = glm::vec3(0.2f, 0.1f, 0.8f);
glm::vec3 bezierCurveColor = glm::vec3(0.9f, 0.7f, 0.0f);
